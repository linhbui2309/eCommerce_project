                ...
                @if (session('status'))
                    <div class="alert alert-success">{{session('status')}}</div>
                     @endif
                                        ...
                                        <form method="get" action="{{ url('profile/'.$profile->id.'/edit') }}">
                                        @csrf
                                        @method('PUT')
