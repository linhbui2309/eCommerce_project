                                    ...
                                    <div class="profile-pic text-center mb-5">
                                        ...
                                        <div>
                                            <div class="relative h-24 w-24 mx-auto">
                                                <img src="{{ Auth::user()->image }}" style="height:100px;width:150px;" class="rounded-full shadow dark:shadow-gray-700 ring-4 ring-slate-50 dark:ring-slate-800" id="profile-image" alt="">
